...
| **Validation/** | Validates product schema/rules before use (DB014 / DB021). | `db021_validator.py`, `schema_loader.py`; see `Documents/Database/2026 Trimester 1/DB014-Dataset-Validation.md` |
