  ...
  return (
    <View className="flex-1 p-safe">
      <View className="flex-1 items-center justify-center px-6">
        <IconGeneral type="warning" fill="hsl(0, 0% 30%)" size={40} />
        <Tt className="font-interBold text-lg text-hsl30 mt-4">{title}</Tt>
        <Tt className="text-center text-hsl30 mt-2">{message}</Tt>
